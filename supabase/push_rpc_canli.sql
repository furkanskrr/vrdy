-- Push bildirim RPC'leri (canlı Supabase'de bir kez çalıştırın)
-- Uygulama RPC yoksa profil sorgusu yedeği kullanır; yine de bu fonksiyonları eklemeniz önerilir.
